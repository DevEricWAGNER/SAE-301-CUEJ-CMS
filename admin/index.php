				...
				if ($error === 0) {
					if ($img_size > 12500000) {
						...
						if (in_array($img_ex_lc, $allowed_exs)) {
							...
							$sql = '	INSERT INTO `element` (`balise`, `classCSS1`, `src1`, `position`, `legende1`, `credit1`, `article`)
										VALUES (:balise, :classCSS1, :src1, :position, :legende1, :credit1, :article);';
							$pdo = connexion();
							$query = $pdo->prepare($sql);
							$query->bindValue(':balise', $balise, PDO::PARAM_STR);
							$query->bindValue(':classCSS1', '', PDO::PARAM_STR);
							$query->bindValue(':src1', $img_upload_path, PDO::PARAM_STR);
							$query->bindValue(':legende1', $_POST['legende'], PDO::PARAM_STR);
							$query->bindValue(':credit1', $_POST['credit'], PDO::PARAM_STR);
							$query->bindValue(':position', $_POST['position'], PDO::PARAM_STR);
							$query->bindValue(':article', $_POST['article'], PDO::PARAM_STR);
							$query->execute();
							header("Location: index.php");
